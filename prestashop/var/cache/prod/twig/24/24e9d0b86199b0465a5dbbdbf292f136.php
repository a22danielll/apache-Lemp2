...
class __TwigTemplate_81d88d6eaf43968bb6f7f7c2efcea303 extends Template
{
    private $source;
    private $macros = [];
...
$context["action"], "type", [], "any", true, true, false, 68) && (twig_get_attribute($this->env, $this->source, $context["action"], "type", [], "any", false, false, false, 68) == "button"))) {
    ...
    {
        return new Source("", "@PrestaShop/Admin/Helpers/bootstrap_popup.html.twig", "/prestashop/src/PrestaShopBundle/Resources/views/Admin/Helpers/bootstrap_popup.html.twig");
    }
}
